...
exports.BoardModule = BoardModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([board_entity_1.Board, user_entity_1.User, article_entity_1.Article, article_comment_entity_1.ArticleComment])],
        controllers: [board_controller_1.BoardController],
        providers: [board_service_1.BoardService, article_service_1.ArticleService],
    })
], BoardModule);
